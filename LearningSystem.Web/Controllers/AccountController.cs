...
namespace LearningSystem.Web.Controllers
{
    ...
    public class AccountController : ServiceController<AccountService<UnitOfWork>>
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { CUsername = model.Username, Email = model.Email, BirthDate = model.BirthDate, UserName = model.Email};
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser { CUsername = model.Username, Email = model.Email, UserName = model.Email};
